                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 rounded">
                            <form class="row g-3" action="{{route('castle.employee.store')}}" method="post">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="birthdate" value="{{old('birthdate')}}" class="form-control datepicker" >
                                    @error("birthdate")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="date_hired" value="{{old('date_hired')}}" class="form-control datepicker" >
                                    @error("date_hired")
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                </div>
